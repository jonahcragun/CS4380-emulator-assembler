...
TEST(mem_cycle_cntr, readByte) {
    ...
    EXPECT_EQ(mem_cycle_cntr, 33);
    b = readByte(1122);
    EXPECT_EQ(mem_cycle_cntr, 34);
    b = readByte(1123);
    EXPECT_EQ(mem_cycle_cntr, 35);
    b = readByte(1124);
    EXPECT_EQ(mem_cycle_cntr, 36);
    b = readByte(1125);
    EXPECT_EQ(mem_cycle_cntr, 37);
    b = readByte(1126);
    EXPECT_EQ(mem_cycle_cntr, 38);
    b = readByte(1127);
    EXPECT_EQ(mem_cycle_cntr, 39);
    b = readByte(1128);
    EXPECT_EQ(mem_cycle_cntr, 40);
    b = readByte(1129);
    EXPECT_EQ(mem_cycle_cntr, 41);
    b = readByte(1130);
    EXPECT_EQ(mem_cycle_cntr, 42);
    b = readByte(1131);
    EXPECT_EQ(mem_cycle_cntr, 43);
    b = readByte(1132);
    EXPECT_EQ(mem_cycle_cntr, 44);
    b = readByte(1133);
    EXPECT_EQ(mem_cycle_cntr, 45);
    b = readByte(1134);
    EXPECT_EQ(mem_cycle_cntr, 46);
    b = readByte(1135);
    EXPECT_EQ(mem_cycle_cntr, 47);
    b = readByte(97);
    EXPECT_EQ(mem_cycle_cntr, 48);
    b = readByte(96);
    EXPECT_EQ(mem_cycle_cntr, 49);
    b = readByte(1135);
    EXPECT_EQ(mem_cycle_cntr, 50);
    ...
    EXPECT_EQ(mem_cycle_cntr, 50);
    b = readByte(2144);
    EXPECT_EQ(mem_cycle_cntr, 65);
    b = readByte(1130);
    EXPECT_EQ(mem_cycle_cntr, 66);
    b = readByte(100);
    EXPECT_EQ(mem_cycle_cntr, 81);
